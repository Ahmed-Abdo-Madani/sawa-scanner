...
- [x] iOS App Store Configurations: Configured location permission strings (`NSLocationWhenInUseUsageDescription`) inside `Info.plist`, and successfully updated the iOS Bundle Identifier to your registered ID `com.ahmedmadani.sawascanner` inside `project.pbxproj`.
