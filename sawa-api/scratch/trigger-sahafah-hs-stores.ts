...
const TRACKER_FILE = path.join(__dirname, 'triggered-sahafah-stores.json');
...
async function main() {
  ...
  // Fetch active HungerStation stores in Riyadh Sahafah district
  console.log('Fetching active HungerStation stores in Sahafah...');
  ...
  console.log(`Found ${stores.length} active stores in Sahafah in database.`);
