...
async function main() {
  ...
  try {
    ...
    // Check if there's any text indicating closed state
    const bodyText = await page.innerText('body');
    const closedKeywords = ['closed', 'currently not accepting', 'busy', 'unavailable', 'مغلق', 'لا يقبل طلبات'];
    ...
    const screenshotPath = 'C:\\Users\\Design_Bench_12\\.gemini\\antigravity\\brain\\7fc14901-b6ca-499d-a8e4-98d918d27b7e\\hs_debug.png';
