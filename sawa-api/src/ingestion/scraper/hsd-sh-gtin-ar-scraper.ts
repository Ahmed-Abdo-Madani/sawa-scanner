...
@Injectable()
export class HsdShGtinArScraper extends SallaGtinArScraper {
  constructor(
    ...
    this.config.cookieSessionPath = './scraper-sessions/hsd-sh-ar';
  }

  /**
   * Searches Hsd-Sh Store locale (hsd-sh.com).
   */
  ...
  override async searchAndGetCandidates(
    ...
    localHashes?: string[],
    baseUrl: string = 'https://hsd-sh.com',
