...
@Injectable()
export class EanaabGtinArScraper extends SallaGtinArScraper {
  constructor(
    ...
    this.config.cookieSessionPath = './scraper-sessions/eanaab-ar';
  }

  /**
   * Searches Eanaab Store locale (eanaab.com).
   */
  ...
  override async searchAndGetCandidates(
    ...
    localHashes?: string[],
    baseUrl: string = 'https://eanaab.com',
