...
@Injectable()
export class NwshaGtinArScraper extends SallaGtinArScraper {
  constructor(
    ...
    this.config.cookieSessionPath = './scraper-sessions/nwsha-ar';
  }

  /**
   * Searches Nwsha Store locale (nwsha.com).
   */
  ...
  override async searchAndGetCandidates(
    ...
    localHashes?: string[],
    baseUrl: string = 'https://nwsha.com',
