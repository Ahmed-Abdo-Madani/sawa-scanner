...
@Injectable()
export class NarjsGtinArScraper extends SallaGtinArScraper {
  constructor(
    ...
    this.config.cookieSessionPath = './scraper-sessions/narjs-ar';
  }

  /**
   * Searches Narjs Store locale (narjs.store).
   */
  ...
  override async searchAndGetCandidates(
    ...
    localHashes?: string[],
    baseUrl: string = 'https://narjs.store',
