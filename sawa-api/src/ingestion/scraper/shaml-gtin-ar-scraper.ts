...
@Injectable()
export class ShamlGtinArScraper extends SallaGtinArScraper {
  constructor(
    ...
    this.config.cookieSessionPath = './scraper-sessions/shaml-ar';
  }

  /**
   * Searches Shaml Store locale (shaml.sa).
   */
