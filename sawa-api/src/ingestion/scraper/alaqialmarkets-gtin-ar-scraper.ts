...
@Injectable()
export class AlaqialMarketsGtinArScraper extends SallaGtinArScraper {
  constructor(
    ...
    this.config.cookieSessionPath = './scraper-sessions/alaqialmarkets-ar';
  }

  /**
   * Searches Alaqial Markets locale (alaqialmarkets.net).
   */
  ...
  override async searchAndGetCandidates(
    ...
    localHashes?: string[],
    baseUrl: string = 'https://alaqialmarkets.net',
