...
/**
 * DTO for the Aliaqtisadia Store Catalog Scrape job.
 * Drives the AliaqtisadiaCatalogScraperService to scrape all products from the storefront categories dynamically.
 */
export class AliaqtisadiaCatalogJobDto {
  @IsOptional()
  @IsBoolean()
  dryRun?: boolean;
