...
async function bootstrap() {
  console.log('🚀 Bootstrapping Minimal NestJS Context for Full Etaam Express Catalog Scrape (No Redis)...');
  ...
  try {
    ...
    console.log('Progress will be saved locally to "./etaamexpress-scrape-progress.json"\n');
